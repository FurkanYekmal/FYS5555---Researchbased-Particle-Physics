...
void MySelector::Begin(TTree * /*tree*/)
{
  ...
  for( const auto & chn:channels ){
    ...
    h_mll[chn] = new TH1D("h_"+chn+"_mll", chn+"_mll", 100, 0, 2000); 		
  }
...
Bool_t MySelector::Process(Long64_t entry)
{
  ...
  //Cut #4: Transverse energy moment should be over 90 after the Z decay to lepton pair if Dark Matter Particles
  if (TwoLeptons) {
     if(met_et[0]/1000. >90) {return kTRUE}
     if(met_et[1]/1000. >90) {return kTRUE}
  }
  //Cut #5: Transverse energy/H_T must be bigger than 0.6
  ...
  if(channel == "ee"){
    if(lep_pt[0]/1000.0 < 30){return kTRUE;} 
    if(lep_pt[1]/1000.0 < 30){return kTRUE;} 
  ...
  if(lep_pt[0]>lep_pt[1]){
    l1.SetPtEtaPhiE(lep_pt[0]/1000.0, lep_eta[0], lep_phi[0], lep_E[0]/1000.0);
    l2.SetPtEtaPhiE(lep_pt[1]/1000.0, lep_eta[1], lep_phi[1], lep_E[1]/1000.0);
  }
  if(lep_pt[1]>lep_pt[0]){
    l1.SetPtEtaPhiE(lep_pt[1]/1000.0, lep_eta[1], lep_phi[1], lep_E[1]/1000.0);
    l2.SetPtEtaPhiE(lep_pt[0]/1000.0, lep_eta[0], lep_phi[0], lep_E[0]/1000.0);
  }
