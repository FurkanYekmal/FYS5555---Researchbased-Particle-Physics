...
fileIDs = {'ZZ':ZZ, 'WZ':WZ, 'Zjets':Zjets, "Top":Top, "Diboson":Diboson}
...
colours = dict(Diboson=kAzure+1, WZ=kRed+1, ZZ = kOrange+2, Top = kGreen+3, Zjets=kGray) 
...
bkg_labels = {'Zjets':'Z+jets', 'ZZ':'ZZ', 'WZ':'WZ', "Diboson":"Diboson", "Top":"Top"}
